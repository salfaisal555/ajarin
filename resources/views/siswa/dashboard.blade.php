<x-app-layout>
    ...
    <a href="{{ route('student.catalog') }}" 
       class="text-sm font-bold text-teal-600 bg-white px-4 py-2 rounded-lg shadow hover:bg-teal-50 transition">
        + Tambah Kelas Baru
    </a>
</div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all group border border-gray-100">
                <!-- Perbaikan Warna Gradient Card Menjadi Teal/Cyan -->
                <div class="h-32 bg-gradient-to-br from-teal-500 to-cyan-600 p-6 relative overflow-hidden">
                    <h3 class="text-xl font-bold text-white relative z-10 line-clamp-2 leading-tight">{{ $course->title }}</h3>
                ...
                <div class="p-6">
                    ...
                    <a href="{{ route('student.corridor', $course->id) }}" class="block w-full text-center bg-teal-600 hover:bg-teal-700 text-white font-bold py-3 rounded-xl transition shadow-lg shadow-teal-500/30 hover:-translate-y-0.5 active:scale-95">
                        Lihat Koridor Kelas &rarr;
                    </a>
                </div>
            </div>
            @empty
            <div class="col-span-full text-center py-20 bg-white rounded-2xl shadow-lg border border-gray-100">
